...
<div class="p1">
  ...
  <m-fixedbtn :popupShow.sync="isPopupOpen" :page="`page1`"></m-fixedbtn>
  ...
  <fixed-menu :page="`page1`" :inPage="[false, true, true]"></fixed-menu>
...
<script>
import kv from 'components/page1/kv';
import titlewrap from 'components/page1/titlewrap';
import article1 from 'components/page1/article1';
import article2 from 'components/page1/article2';
import article3 from 'components/page1/article3';
import article4 from 'components/page1/article4';
import article5 from 'components/page1/article5';
...
import nomurafooter from 'components/page1/nomurafooter';
...
export default {
  ...
  data() {
    return {
      canPlay: false,
      menuItem: ['境內首檔邊境債', '基金特色', '債券領航家', '經理人開講', '基金小檔案'],
      articlePosition: [],
      isPopupOpen: false,
...
@media screen and (max-width: 1024px) {
  ...
  .menu-btn_wrap {
    ...
    .color-red { border-color: #004695; }
    .color-green { border-color: #004695; }
    .icon { display: none; }
  }
}
  ...
  .menu-btn_wrap {
    ...
    .text {
      ...
      &2:after {
        width: 54/750*100vw;
        height: 52/750*100vw;
        background-position: -63/750*100vw 0;
      }
      &3:after {
        width: 48/750*100vw;
        height: 38/750*100vw;
        background-position: -63/750*100vw -59/750*100vw;
      }
    }
